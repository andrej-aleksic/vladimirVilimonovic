$(document).ready(function () {
    const images = [
        ...
        { src: 'img/Heliocopter Rescue - Serbia 1.jpg', description: 'Helicopter Rescue - Serbia' },
        ...
        {src:'img/Alpine Skier - Kopaonik, Serbia.jpg', description: 'Alpine Skier - Kopaonik, Serbia'},
        {src:'img/Freestyle Snowboarding - Kopaonik, Serbia (1).jpg', description: 'Freestyle Snowboarding - Kopaonik, Serbia'},
        {src:'img/Nikola Vuckovic - Durmitor National Park, Montenegro 2.jpg', description: 'Nikola Vuckovic - Durmitor National Park, Montenegro'},
        ...
        { src: 'img/Heliocopter Rescue - Serbia 2.jpg', description: 'Helicopter Rescue - Serbia' },
